...
class ServicesFragment : BaseFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = presenterFactory.createServicesPresenter()
    }
    ...
    override fun onCreateView(
        ...
        val view: ServicesMvpView = mvpViewFactory.createServicesMvpView(container, this)
    ...
    companion object {
        fun newInstance(): Fragment = ServicesFragment()
    }
